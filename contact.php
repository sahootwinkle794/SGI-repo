...
<section class="contact-info">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 wow fadeInLeft" data-wow-delay="100ms">
            ...
            <!--Contact Two Single Start-->
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="200ms">
                <div class="contact-info__single">
                    <div class="contact-info__icon">
            ...
            <!--Contact Two Single End-->
            <!--Contact Two Single Start-->
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="300ms">
                <div class="contact-info__single">
                    <div class="contact-info__icon">
