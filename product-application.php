...
<section class="about-two custom-about-two-new">
    <div class="about-two__shape-3 float-bob-x">
        <img src="assets/images/shapes/about-two-shape-3.png" alt="">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-6">
                <div class="about-two__left application-new-style wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms">
                    <div class="about-two__img-box">
                        <div class="about-two__img">
                        ...
                        <div class="about-two__experience product-application-new-style">
            ...
            <div class="col-xl-6">
                <div class="about-two__right food-irradiation-new-style">
                    <div class="section-title text-left sec-title-animation animation-style2">
                        <div class="section-title__tagline-box">
                            <div class="section-title__shape-1">
                                <img src="assets/images/resources/section-title-shape-1.png" alt="">
...
<section class="about-two custom-about-two-new-bottom">
    <div class="about-two__shape-3 float-bob-x">
        <img src="assets/images/shapes/about-two-shape-3.png" alt="">
    </div>
    <div class="container mb-5">
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="about-two__right iqf-new-style">
                    <div class="section-title text-left sec-title-animation animation-style2">
                        <div class="section-title__tagline-box">
                            <div class="section-title__shape-1">
                                <img src="assets/images/resources/section-title-shape-1.png" alt="">
